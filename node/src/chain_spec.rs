...
pub fn gameland_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../../resources/gameland.json")[..])
}
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(appchain_gameland_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
